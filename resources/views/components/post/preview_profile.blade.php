    ...
    <div class=" row  pb-3" >
        <div class="col-md-10 ml-5 Post pl-0 shadow d-flex justify-content-between align-items-center rounded-lg" style="background: #fff;">
            <div class="row row-flex w-100 pl-3">
                <div class=" col-md-1 pl-0 pr-0"  style="border-left: 5px solid #17756D !important; border-top-left-radius: 5px;border-bottom-left-radius:5px;background: #e0eceb; color: #707070;background-size: cover;">
                    <div class="text-center ">
                        ...
                        <p class="@if(auth()->user()) mt-n2 @else mt-3 @endif" style="margin-bottom:0px!important;padding-bottom: 0px!important;" id="{{$post->id}}">{{$post->upvotes_count - $post->downvotes_count}}</p>
