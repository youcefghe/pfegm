            ...
            success: function (response) {
                ...
                for (var i = 0; i <= content.length - 1; i++) {
                    if (post[content[i].id] && post[content[i].id].length > 0) {
                        ...
                        // var link = "<a data-toggle='tooltip' data-html='true' href='/community/"+  post[content[i].id][0].community_id+"/posts/"+post[content[i].id][0].element_id+"' class='mr-1' rel='tooltip' title='" + div.innerHTML + "' ><i class='fa fa-info-circle' ></i></a>"
